...
class AdminElectionVotersScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminElectionVotersScreen> createState() => _AdminElectionVotersScreenState();
}

class _AdminElectionVotersScreenState extends ConsumerState<AdminElectionVotersScreen> {
                ...
                Expanded(
                  child: electionAsync.when(
                    data: (e) => Column(
                      ...
                      children: [
                        Text(e.title, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: AppTheme.textPrimary), overflow: TextOverflow.ellipsis),
                        Row(children: [
                          const Text('Voter List', style: TextStyle(fontSize: 12, color: AppTheme.textSecondary)),
              ...
              data: (voters) {
                final filtered = _search.isEmpty
                    ...
                    : voters.where((v) =>
                        ...
                        v.email.toLowerCase().contains(_search)).toList();
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text('${voters.length} total', style: const TextStyle(fontSize: 12, color: AppTheme.primary, fontWeight: FontWeight.w700)),
                                  ),
                                ],
                              ),
                    ...
                    if (filtered.isEmpty)
                      SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Center(
                            child: Text(
                              _search.isNotEmpty ? 'No voters match "$_search".' : 'No voters on this list yet.',
                          ...
                          (_, i) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                title: Text(v.fullName, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
